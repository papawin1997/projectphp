...
?>
   ...
   <ul class="header__nav">
                        ...
                        <?php } ?>
                    </ul> <!-- end header__nav --> <!-- end header__nav -->
        ...
        <table width="500" border="1" align="center" id="member_table">
            <tbody>
                <tr>
                    ...
                    <td width="224" scope="col"><?php echo $objResult["Username"]; ?>
                </tr>
                <tr>
                    <td>&nbsp;ชื่อ-นามสกุล</td>
                ...
                <tr>
                    <td align="center" valign="middle"><strong>รหัสผ่าน</strong></td>
                    <td>
                ...
                <tr>
                    ...
                    <td>    <input name="txtConPassword" type="password" id="txtConPassword" placeholder="ยืนยันรหัสผ่าน">
            <span class="error"><?php echo $conpassErr;?></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input name="txtTelephone" type="text" id="txtTelephone" value="<?=$objResult["Telephone"];?>"></td>
                </tr>
                <tr>
